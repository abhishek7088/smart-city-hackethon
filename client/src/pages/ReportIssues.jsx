...
const ReportIssues = () => {
  ...
  const [markerPosition, setMarkerPosition] = useState({ latitude: 20.5937, longitude: 78.9629 }); // Default to India's center
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMarkerPosition({ latitude: 20.5937, longitude: 78.9629 }); // Reset to default
    } catch (error) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-blue-100 p-6">
      <div className="max-w-4xl w-full bg-white shadow-lg rounded-xl text-black border border-blue-200 flex">
        ...
        <div className="w-1/2 p-6">
          ...
          <MapContainer center={[20.5937, 78.9629]} zoom={5} style={{ width: "100%", height: "300px" }} whenCreated={(mapInstance) => (mapRef.current = mapInstance)}>
